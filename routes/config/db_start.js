...
INSERT INTO `fake_reports` (`id`, `reporter`, `reported`) VALUES (1, 4, 12);\
...
(62, 2, NULL, 'Hi test! I am great I have just fixed this fucking bug!!!!', '2018-12-06 18:18:08', 7),\
(63, 3, NULL, 'Oh! very well. Now create normal chat then. It should work on sockets! It is mandatory', '2018-12-06 18:43:14', 7),\
...
(100, 3, NULL, 'I am very well! I have just send message to white_men, and you haven not got it!!! Ha-ha-ha! But you should get this message this time!', '2018-12-07 19:18:28', 6),\
(101, 3, NULL, 'What is happening?', '2018-12-07 19:20:05', 6),\
(102, 3, NULL, 'Root will not get this message.', '2018-12-07 19:20:29', 7),\
...
(110, 4, NULL, 'You still do not see my messages?', '2018-12-07 19:41:42', 6),\
...
(126, 4, NULL, 'It posts my messages like I am not their autor =(', '2019-02-06 17:30:55', 13),\
...
(135, 3, NULL, 'Let us try group chat', '2019-02-11 18:05:23', 20),\
(136, 3, NULL, 'My test again)', '2019-02-11 18:05:56', 20),\
(137, 3, NULL, 'Let us try one more test', '2019-02-11 18:06:02', 20),\
(138, 3, NULL, 'It should work this time)', '2019-02-11 18:06:11', 20),\
(139, 4, NULL, 'This is a test', '2019-02-11 18:07:56', 21),\
(140, 4, NULL, 'Hey Girl, whats is new?', '2019-02-11 18:08:08', 21),\
(141, 3, NULL, 'Ok, let us get it started', '2019-02-11 18:09:12', 20),\
(142, 2, NULL, 'Hey Girl!', '2019-02-11 18:10:25', 21),\
(143, 2, NULL, 'Glad to see ya)', '2019-02-11 18:10:31', 21),\
(144, 13, NULL, 'I am very well!', '2019-02-11 18:11:19', 21),\
(145, 13, NULL, 'Nice to meet you, guys)', '2019-02-11 18:11:29', 21),\
(146, 13, NULL, 'What are your names?', '2019-02-11 18:11:42', 21),\
(147, 2, NULL, 'Let us try to test live notifications', '2019-02-11 18:14:15', 21),\
(148, 13, NULL, 'Wow! That is great! I saw the message from another page!', '2019-02-11 18:14:44', 21),\
(149, 13, NULL, 'Really fantastic!', '2019-02-11 18:14:54', 21),\
(150, 13, NULL, 'Awesome)', '2019-02-11 18:14:58', 21),\
(151, 13, NULL, 'Let us try again. Seems to be some bug =(', '2019-02-11 18:15:45', 21),\
(152, 2, NULL, 'It is ok but I am not sure what happened...', '2019-02-11 18:16:07', 21),\
(153, 13, NULL, 'Ok, I think I see what is the problem', '2019-02-11 18:18:01', 21),\
...
(159, 4, NULL, 'Don not flood here, I am admin!)', '2019-02-11 18:23:10', 21),\
(160, 13, NULL, 'Aha, You still did not implement block logic))', '2019-02-11 18:23:49', 21),\
...
(173, 4, NULL, 'Hi, let us talk privately', '2019-02-11 18:51:17', 15),\
...
(4, 'root', 'sha256$3acf68e5$1$5125e220c378c94a1f5d419cf6f5a62cc1c3cfc763e0d965422fddcba5ce6bec', 'root@example.com', 'Daddy', 'Root', 1, 1, 'Will not say anything) Hahaha', 29, 'Male', 'Heterosexual', '2019-02-19 20:58:53', 0, 29),\
